---
command: /interactive:generate-witness
...
Interesting Scenarios:
  ...
  • Byzantine behavior - Can Byzantine nodes act?
...
2. **Detect Interesting States**
   - Analyze spec to identify meaningful scenarios:
     ...
     **Value-based scenarios** (analyze types/domains):
     ...
     - Byzantine participation: `|byzantine_actors| > 0`
...
5. **Generate Specific Witness Goals**
   - Per selected scenario type, create concrete witness goals:
     ...
     - Goal: "Byzantine node acts"
       - Condition: `exists b in byzantine. b sent message`
       - Rationale: Verify Byzantine behavior modeled
...
9. **Generate Witness Module Header**
   ...
   - Construct:
     ...
     module <spec_name>_witnesses {
       ...
       //
       // Usage: quint run <file> --invariant=<witness_name> --max-steps=N
       //
...
10. **Generate Witness Invariants**
    - Per witness scenario:
      ...
      - Build invariant definition:
        ...
        //
        // Run: quint run --invariant={scenario.name} --max-steps={max_steps} --max-samples=1000
        // ──────────────────────────────────────────────────────────
...
14. **Write Witness File**
    - Construct complete file:
      ...
      // Generated by /interactive:generate-witness-scenarios
      //
...
16. **Generate Witness Catalog Documentation**
    - Add to file header:
      ...
      //
      // Usage:
      //   quint run <file> --main=<WitnessName> --max-steps={max_steps}
      //
...
17. **Display Success Summary**
    - Output:
      ...
      Next Steps:
        Run witness:     quint run <output_path> --main=<spec_module> --invariant=<witness_name> --max-steps={max_steps} --max-samples=1000
...
**Input**:
```
/interactive:generate-witness-scenarios \
