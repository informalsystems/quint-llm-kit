...
1. **Quint Specification Path**: Path to the .qnt specification file
   - Example: `specs/tendermint5f/tendermint5f.qnt`

2. **Crate Name**: Name for the test crate
   - Example: `informalsystems-malachitebft-test-mbt`

3. **Crate Location**: The location to create the test crate
   - Example: `code/crates/test/mbt`

4. **First Test Name**: Name of an initial test from the Quint spec
...
Present your findings to the user and ask for confirmation before proceeding.
...
14. **STOP and wait for user to confirm before proceeding to the next transition**
